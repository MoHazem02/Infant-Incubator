...
class Ui_Monitor(object):
    def setupUi(self, Monitor):
        ...
        Monitor.resize(900, 650)
        Monitor.setMinimumSize(QtCore.QSize(880, 600))
        ...
        self.set_button.setGeometry(QtCore.QRect(160, 210, 181, 31))
...
"border-radius: 8px;")
        ...
        self.temp_LCD.setGeometry(QtCore.QRect(10, 160, 111, 61))
        self.temp_LCD.setObjectName("temp_LCD")
        self.increase_button = QtWidgets.QPushButton(self.groupBox_3, clicked = lambda: Main.increment_boundry_temp())
        self.increase_button.setEnabled(True)
        self.increase_button.setGeometry(QtCore.QRect(270, 170, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
...
"border-radius: 8px;")
        ...
        self.decrease_button = QtWidgets.QPushButton(self.groupBox_3, clicked = lambda: Main.decrement_boundry_temp())
        self.decrease_button.setGeometry(QtCore.QRect(160, 170, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
...
"border-radius: 8px;")
        ...
        self.temp_LCD_2 = QtWidgets.QLCDNumber(self.groupBox_3)
        self.temp_LCD_2.setGeometry(QtCore.QRect(30, 40, 161, 71))
        self.temp_LCD_2.setObjectName("temp_LCD_2")
        self.label_2 = QtWidgets.QLabel(self.groupBox_3)
        self.label_2.setGeometry(QtCore.QRect(20, 230, 81, 21))
        self.label_2.setObjectName("label_2")
        self.BPM_Frame_2 = QtWidgets.QFrame(self.groupBox_3)
        self.BPM_Frame_2.setGeometry(QtCore.QRect(240, 40, 120, 80))
        self.BPM_Frame_2.setStyleSheet("image: url(:/newPrefix/thermometer.png);")
        self.BPM_Frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.BPM_Frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.BPM_Frame_2.setObjectName("BPM_Frame_2")
    ...
    def retranslateUi(self, Monitor):
        ...
        self.label_2.setText(_translate("Monitor", "Control"))
